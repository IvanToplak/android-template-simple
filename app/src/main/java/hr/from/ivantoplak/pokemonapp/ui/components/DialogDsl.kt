package hr.from.ivantoplak.pokemonapp.ui.components
...
/**
 * DialogDsl is an example of how to create customisable AlertDialog by using Kotlin DSL.
 */
@DslMarker
...
class DialogBuilder(
    ...
    private val setup: DialogBuilder.() -> Unit = {}
) {
