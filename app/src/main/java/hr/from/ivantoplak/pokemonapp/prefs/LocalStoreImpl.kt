package hr.from.ivantoplak.pokemonapp.prefs
...
private const val PreferenceFileName = "hr.from.ivantoplak.pokemonapp.USER_PREFS"
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = PreferenceFileName)
